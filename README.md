...
Each constitutive relation — closure laws, conductivity, cavity opening — is exposed as a swappable function, so you can test alternative physics without modifying the solver.
